...
<body <?php body_class($class); ?> data-spy="scroll" data-target=".onpage-navigation" data-offset="60">
	...
	<div id="page" class="site">
		<a class="skip-link innofit-screen-reader"
			href="#content"><?php esc_html_e( 'Skip to content', 'innofit' ); ?></a>
		<div id="wrapper">
			...
			<nav class="navbar navbar-custom navbar-fixed-top one-page desktop-header" role="navigation">
				<?php } else { ?>
				<nav class="navbar navbar-custom <?php if(is_page_template('template-business.php')) { echo 'navbar-transparent'; } ?> navbar-fixed-top one-page desktop-header"
					role="navigation">
					<?php } ?>
